...
与 [Vue 的 Prop 类型校验](https://cn.vuejs.org/guide/components/props.html#prop-validation) 一致。
...
各版本详细改动请参考 [release notes](https://github.com/cloydlau/vue-global-config/releases) 。
